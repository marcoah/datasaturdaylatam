                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control @error('mensaje_adicional') is-invalid @enderror" id="mensaje_adicional"
                                        name="mensaje_adicional" rows="2">{{ old('mensaje_adicional') }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('tipo') is-invalid @enderror" id="tipo"
                                        ...
                                        <option value="primary" {{ old('tipo') === 'primary' ? 'selected' : '' }}>Primary
                                            (Azul)</option>
                                        <option value="secondary" {{ old('tipo') === 'secondary' ? 'selected' : '' }}>
                                            Secondary (Gris)</option>
                                        <option value="success" {{ old('tipo') === 'success' ? 'selected' : '' }}>Success
                                            (Verde)</option>
                                        <option value="danger" {{ old('tipo') === 'danger' ? 'selected' : '' }}>Danger
                                            (Rojo)</option>
                                        <option value="warning" {{ old('tipo') === 'warning' ? 'selected' : '' }}>Warning
                                            (Amarillo)</option>
                                        <option value="info" {{ old('tipo') === 'info' ? 'selected' : '' }}>Info (Cyan)
                                        </option>
                                        <option value="light" {{ old('tipo') === 'light' ? 'selected' : '' }}>Light
                                            (Claro)</option>
                                        <option value="dark" {{ old('tipo') === 'dark' ? 'selected' : '' }}>Dark (Oscuro)
                                        </option>
                                    </select>
                                    @error('tipo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-sm-10 offset-sm-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="activa" name="activa"
                                            value="1" {{ old('activa', true) ? 'checked' : '' }}>
