                ...
                <form method="post" action="{{ route('clientes.store') }}" class="row g-3 needs-validation" novalidate
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="pills-basico-tab" data-bs-toggle="pill"
                                        href="#pills-basico" role="tab" aria-controls="pills-basico"
                                        aria-selected="true">Datos Básicos</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-direcciones-tab" data-bs-toggle="pill"
                                        href="#pills-direcciones" role="tab" aria-controls="pills-direcciones"
                                        aria-selected="false">Datos direcciones</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="pills-usuarios-tab" data-bs-toggle="pill" href="#pills-usuarios"
                                        role="tab" aria-controls="pills-usuarios" aria-selected="false">Usuario
                                        asociado</a>
                                </li>
                            </ul>
                        </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <fieldset class="row mb-3">
                                                        <legend class="col-form-label col-sm-2 float-sm-left pt-0">Tipo
                                                            Cliente</legend>
                                                        <div class="col-sm-10">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="tipo" id="juridico" value="JURIDICO">
                                                                <label class="form-check-label"
                                                                    for="gridRadios1">Juridico</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                    name="tipo" id="natural" value="NATURAL">
                                                                <label class="form-check-label"
                                                                    for="gridRadios2">Natural</label>
                                                            </div>
                                                        </div>
                                                    </fieldset>

                                                    <div class="row mb-3">
                                                        <label for="codigo_tributario"
                                                            class="col-sm-2 col-form-label">Codigo Tributario</label>
                                                        <div class="col-lg-10">
                                                            <input type="text" class="form-control"
                                                                id="codigo_tributario" name="codigo_tributario" disabled>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group row">
                                                        <label for="email1" class="col-sm-4 col-form-label">Email
                                                            1</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="email2" class="col-sm-4 col-form-label">Email
                                                            2</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="telefono1" class="col-sm-4 col-form-label">Telefono
                                                            1</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="telefono2" class="col-sm-4 col-form-label">Telefono
                                                            2</label>
                                                        <div class="col-sm-6">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input type="text" class="form-control" id="ciudad2"
                                                                name="ciudad2">
                                                        </div>
                                                        <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <input type="text" class="form-control" id="pais2"
                                                                name="pais2">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-select" id="user_id" name="user_id"
                                                                ...
                                                                <option value="" selected>Seleccione un usuario
                                                                </option>
                        ...
                        <div class="card-footer">
                            ...
                            <a class="btn btn-danger btn-lg" href="{{ route('clientes.index') }}"
