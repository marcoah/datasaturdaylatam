            ...
            <div class="container">
                ...
                <div class="sponsors-section">
                    ...
                    <div class="sponsors-logos">
                        <img src="{{ asset('frontpage/assets/img/clients/clients-1.webp') }}" alt="Partner Logo"
                            class="sponsor-logo">
                        <img src="{{ asset('frontpage/assets/img/clients/clients-3.webp') }}" alt="Partner Logo"
                            class="sponsor-logo">
                        <img src="{{ asset('frontpage/assets/img/clients/clients-5.webp') }}" alt="Partner Logo"
                            class="sponsor-logo">
                        <img src="{{ asset('frontpage/assets/img/clients/clients-7.webp') }}" alt="Partner Logo"
                            class="sponsor-logo">
                        <img src="{{ asset('frontpage/assets/img/clients/clients-9.webp') }}" alt="Partner Logo"
                            class="sponsor-logo">
                        <img src="{{ asset('frontpage/assets/img/clients/clients-11.webp') }}" alt="Partner Logo"
                            class="sponsor-logo">
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="visual-section">
                        <div class="image-wrapper">
                            <img src="{{ asset('frontpage/assets/img/events/showcase-5.webp') }}" alt="Tech Summit"
                                class="img-fluid">
            ...
            <div class="founder-quote">
                <div class="row align-items-center">
                    <div class="col-lg-3 text-center">
                        <img src="{{ asset('frontpage/assets/img/person/person-m-8.webp') }}" alt="Sarah Johnson"
                            class="founder-img">
                    </div>
                    <div class="col-lg-9">
                        <blockquote>
                            ...
                            <div class="col-md-5">
                                <div class="speaker-image">
                                    <img src="{{ asset('frontpage/assets/img/events/speaker-8.webp') }}"
                                        alt="Emily Rodriguez" class="img-fluid">
                ...
                <div class="col-lg-6">
                    <div class="speaker-card featured">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="speaker-image">
                                    <img src="{{ asset('frontpage/assets/img/events/speaker-1.webp') }}"
                                        alt="Marcus Thompson" class="img-fluid">
                                    <div class="speaker-social">
                                        <a href="#" aria-label="LinkedIn"><i class="bi bi-linkedin"></i></a>
                                        <a href="#" aria-label="Twitter"><i class="bi bi-twitter"></i></a>
                                    </div>
            ...
            <div class="row gy-4 mt-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="speaker-card compact">
                        <div class="speaker-image">
                            <img src="{{ asset('frontpage/assets/img/events/speaker-11.webp') }}" alt="Sarah Chen"
                                class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="speaker-card compact">
                        <div class="speaker-image">
                            <img src="{{ asset('frontpage/assets/img/events/speaker-12.webp') }}" alt="David Wilson"
                                class="img-fluid">
                            <div class="speaker-overlay">
                                <div class="speaker-social">
                                    <a href="#" aria-label="LinkedIn"><i class="bi bi-linkedin"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="speaker-card compact">
                        <div class="speaker-image">
                            <img src="{{ asset('frontpage/assets/img/events/speaker-3.webp') }}" alt="Lisa Martinez"
                                class="img-fluid">
                            <div class="speaker-overlay">
                                <div class="speaker-social">
                                    <a href="#" aria-label="LinkedIn"><i class="bi bi-linkedin"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="speaker-card compact">
                        <div class="speaker-image">
                            <img src="{{ asset('frontpage/assets/img/events/speaker-9.webp') }}" alt="James Parker"
                                class="img-fluid">
                            <div class="speaker-overlay">
                                <div class="speaker-social">
                                    <a href="#" aria-label="LinkedIn"><i class="bi bi-linkedin"></i></a>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="speaker-quote">
                        ...
                        <div class="quote-author">
                            <img src="{{ asset('frontpage/assets/img/events/speaker-2.webp') }}" alt="Emily Rodriguez"
                                class="img-fluid">
                        ...
                        <div class="time-slot">
                            ...
                            <div class="sessions-row">
                                <div class="session-card development">
                                    ...
                                    <div class="speaker">
                                        <img src="{{ asset('frontpage/assets/img/events/speaker-2.webp') }}"
                                            alt="Speaker" class="speaker-image">
                                        <div class="speaker-details">
                                            <h5>Michael Chen</h5>
                                ...
                                <div class="session-card design">
                                    ...
                                    <div class="speaker">
                                        <img src="{{ asset('frontpage/assets/img/events/speaker-3.webp') }}"
                                            alt="Speaker" class="speaker-image">
                                        <div class="speaker-details">
                                            <h5>Emily Rodriguez</h5>
                                ...
                                <div class="session-card business">
                                    ...
                                    <div class="speaker">
                                        <img src="{{ asset('frontpage/assets/img/events/speaker-4.webp') }}"
                                            alt="Speaker" class="speaker-image">
                                        <div class="speaker-details">
                                            <h5>David Park</h5>
        ...
        <div class="container">
            ...
            <div class="row g-0 clients-wrap">
                ...
                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-1.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-2.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-3.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-4.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-5.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-6.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-7.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-3 col-md-4 client-logo">
                    <img src="{{ asset('frontpage/assets/img/clients/clients-8.webp') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->
              ...
              "breakpoints": {
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="testimonial-header">
                                <img src="{{ asset('frontpage/assets/img/person/person-f-12.webp') }}" alt="Client"
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="testimonial-header">
                                <img src="{{ asset('frontpage/assets/img/person/person-m-8.webp') }}" alt="Client"
                                    class="img-fluid" loading="lazy">
                                <div class="rating">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="testimonial-header">
                                <img src="{{ asset('frontpage/assets/img/person/person-f-6.webp') }}" alt="Client"
                                    class="img-fluid" loading="lazy">
                                <div class="rating">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="testimonial-header">
                                <img src="{{ asset('frontpage/assets/img/person/person-m-12.webp') }}" alt="Client"
                                    class="img-fluid" loading="lazy">
                                <div class="rating">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="testimonial-header">
                                <img src="{{ asset('frontpage/assets/img/person/person-f-10.webp') }}" alt="Client"
                                    class="img-fluid" loading="lazy">
                                <div class="rating">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
