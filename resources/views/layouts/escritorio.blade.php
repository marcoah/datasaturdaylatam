...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('home') }}" class="logo d-flex align-items-center"><img
                    src="{{ url('assets/img/logo.png') }}" alt=""><span
                    class="d-none d-lg-block">{{ config('app.name', 'Laravel') }}</span></a>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        @can('roles-read')
                            ...
                            <li>
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('roles.index') }}">
                                    <i class="fa-solid fa-shield fa-sm fa-fw mr-2 text-gray-400"></i>
                                    {{ __('Roles') }}
                                </a>
                            </li>
                        @endcan
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" data-bs-toggle="modal"
                                data-bs-target="#LogoutModal" href="#">
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <!-- Evento Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#evento-nav" data-bs-toggle="collapse" href="#">
            ...
            <!-- Hoteles Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#hoteles-nav" data-bs-toggle="collapse"
                    href="#">
            ...
            <!-- Restaurantes Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#restaurantes-nav" data-bs-toggle="collapse"
                    href="#">
            ...
            <!-- Actividades Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#actividades-nav" data-bs-toggle="collapse"
                    href="#">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Marco Hernandez</span></strong>. All Rights Reserved
        </div>
    </footer><!-- End Footer -->
