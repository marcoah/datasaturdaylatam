...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Más paginas</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('frontpage.tickets') }}">Tickets</a></li>
                            <li><a href="{{ route('frontpage.buy-tickets') }}">Buy Tickets</a></li>
                            <li><a href="{{ route('frontpage.gallery') }}">Gallery</a></li>
                            <li><a href="{{ route('frontpage.terms') }}">Terms</a></li>
            ...
            <a class="btn-getstarted" href="{{ route('frontpage.buy-tickets') }}">Buy Tickets</a>
